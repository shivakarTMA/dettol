...
const SchoolDashboardTables = () => {  
  ...
  const milestonesData = {  
    milestone1: [  
      { id: 1, name: "LN Public School", total: 52, male: 32, female: 20 },  
      { id: 2, name: "Dewan Public School", total: 60, male: 38, female: 22 },  
      { id: 3, name: "Miniland Convent School", total: 48, male: 30, female: 18 },  
      { id: 4, name: "Little Flower Public School", total: 50, male: 25, female: 25 },  
    ],  
    milestone2: [  
      { id: 1, name: "LN Public School", total: 65, male: 35, female: 30 },  
      { id: 2, name: "Dewan Public School", total: 70, male: 40, female: 30 },  
      { id: 3, name: "Miniland Convent School", total: 55, male: 28, female: 27 },  
      { id: 4, name: "Little Flower Public School", total: 60, male: 32, female: 28 },  
    ],  
    milestone3: [  
      { id: 1, name: "LN Public School", total: 80, male: 45, female: 35 },  
      { id: 2, name: "Dewan Public School", total: 78, male: 40, female: 38 },  
      { id: 3, name: "Miniland Convent School", total: 70, male: 37, female: 33 },  
      { id: 4, name: "Little Flower Public School", total: 68, male: 34, female: 34 },  
    ],  
  };  

  // Dummy data for School Wise Active Students  
  const allActiveStudentsData = [  
    { id: 1, name: "LN Public School", enrolled: 20, registered: 15, active: 10, date: "2025-10-20" },  
    { id: 2, name: "Dewan Public School", enrolled: 25, registered: 20, active: 18, date: "2025-10-21" },  
    { id: 3, name: "Miniland Convent School", enrolled: 15, registered: 12, active: 10, date: "2025-10-22" },  
    { id: 4, name: "Little Flower Public School", enrolled: 18, registered: 14, active: 12, date: "2025-10-23" },  
  ];  
  ...
  // Handle milestone dropdown selection change  
  const handleMilestoneChange = (selected) => setSelectedMilestone(selected);  
  ...
  // Memoized filtered milestone data  
  const filteredMilestonesData = useMemo(  
    () => milestonesData[selectedMilestone.value],  
    [selectedMilestone]  
  );  
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-3">  
      ...
      <div className="bg-white rounded-lg custom--shodow lg:p-4 p-2">  
        <div className="flex justify-between items-center mb-4">  
          <h2 className="lg:text-lg text-[16px] font-semibold text-gray-900">School Wise Milestones Achieved</h2>  
        ...
        <div className="rounded-[10px] overflow-hidden">  
          <div className="relative overflow-x-auto">  
            <table className="min-w-full text-sm text-left">  
              ...
              <tbody>  
                {filteredMilestonesData.map((row) => (  
      ...
      <div className="bg-white rounded-lg custom--shodow lg:p-4 p-2">  
        <div className="flex justify-between items-center mb-4">  
          <h2 className="lg:text-lg text-[16px] font-semibold text-gray-900">School Wise Active Students</h2>  
          <Link to="#" className="underline text-[#009EB2] text-lg">  
            <small>View All</small>  
          </Link>  
        </div>  
        ...
        <div className="rounded-[10px] overflow-hidden">  
          <div className="relative overflow-x-auto">  
            {filteredActiveStudentsData.length > 0 ? (  
              ...
              <p className="text-gray-500 text-center py-6">No data available for the selected date range.</p>  
            )}  
          </div>  
        </div>  
      </div>  
